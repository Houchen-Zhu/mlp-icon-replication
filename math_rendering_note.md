...
Some mathematical formulas in `README.md`,`replication_note.md`, and `Literature_Review.md` are written in LaTeX-style Markdown math notation.
...
2. Open `README.md` or `replication_note.md` or `Literature_Review.md`.
